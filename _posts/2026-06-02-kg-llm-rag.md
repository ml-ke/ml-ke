...
This is where **Knowledge Graphs** enter the picture. Throughout this series, we've explored how KGs capture structured, verifiable facts as networks of entities and relationships. In [Post 1]({% post_url 2025-11-24-knowledge-graphs-fundamentals %}) we covered KG theory. In [Post 2]({% post_url 2026-06-02-building-knowledge-graph-neo4j-python %}) we built the **East African Tech Ecosystem KG**. In [Post 3]({% post_url 2026-06-02-kg-embeddings %}) we learned to embed them. In [Post 4]({% post_url 2026-06-02-kg-production %}) we scaled them to production. Now we bring it all together: **using structured knowledge to ground LLM outputs**.
...
Let's build a Graph RAG system using the **East African Tech Ecosystem KG** from [Post 2]({% post_url 2026-06-02-building-knowledge-graph-neo4j-python %}). We'll use LangChain, Neo4j, and any LLM provider (OpenAI, DeepSeek, or the free NVIDIA NIM API).
...
| 2 | [Building a KG with Neo4j and Python]({% post_url 2026-06-02-building-knowledge-graph-neo4j-python %}) | Constructed the East African Tech Ecosystem KG |
| 3 | [Knowledge Graph Embeddings]({% post_url 2026-06-02-kg-embeddings %}) | TransE, RotatE, ComplEx — learning vector representations |
| 4 | [Graph Neural Networks for KG Reasoning]({% post_url 2026-06-02-gnn-knowledge-graph-reasoning %}) | R-GCN, GAT — link prediction and multi-hop reasoning |
...
- [Graph Neural Networks for Knowledge Graph Reasoning]({% post_url 2026-06-02-gnn-knowledge-graph-reasoning %})
- [Knowledge Graphs in Production]({% post_url 2026-06-02-kg-production %})
