...
3. **Supply chain sovereignty** — the hardware supply and software stack are managed end-to-end by Core42, which runs the [Condor Galaxy](https://g42.ai/technology/condor-galaxy) supercomputer network and has deep relationships with NVIDIA, AMD, and Cerebras.
...
- The G42-NVIDIA [Condor Galaxy](https://g42.ai/technology/condor-galaxy) network already provides some of the largest publicly accessible AI compute clusters outside the US.
...
Kenya's [Digital Transformation Programme](https://www.ict.go.ke/digital-transformation/) and the forthcoming National AI Strategy both emphasise data localisation, digital public infrastructure, and domestically controlled compute. The challenge has always been execution: building sovereign cloud infrastructure is capital-intensive and requires specialised talent that is scarce locally.
...
Kenya is already further along than most African countries. The [Kenya Cloud](https://www.kenyacloud.ke/) initiative, the Ajira Digital programme, and the Konza Technopolis data centre campus provide foundations. What is missing is the integrated vision — compute, platform, and applications — that the UAE has executed with G42.
