...
**⚠️ TUESDAY RULE: Never schedule posts for Tuesdays.** The Tuesday AI Update cron (job a658b981983a, fires 12:00 EAT) auto-generates a Global AI Roundup via web search. Any pre-written post on a Tuesday will collide with this. Move Tuesday-scheduled posts to Monday or Wednesday.
