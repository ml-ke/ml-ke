...
- Build workflow status → "completed success": ~34-75s after push (varies with build load)
- Homepage listing updates: ~30-75s after push (same window as build success)
- Direct permalink returns 200: ~45-75s after push (CDN propagation tail)
