...
9. **web_extract unavailable?** (search-only extract backend) — fetch the article with curl and strip tags in python to confirm exact figures in the body; search snippets are NOT enough for quoted numbers. Recipe + verified figure bank: `references/ai-fraud-incident-bank.md`
