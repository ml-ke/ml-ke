...
### DNS over HTTPS / DNS Rebinding
```python
# Use a custom DNS server that alternates resolution
# between a legitimate IP and a private IP
# Tools: rebind.it, LockHorn (local), dnsrebind.net
```
