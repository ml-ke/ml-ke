...
### 4. AI/ML Engineering Series (COMPLETE — 5 posts + 10 more staged → publishing daily at 14:05 EAT)
...
- Jun 3: Self-Evolving Agent Skills (`.scheduled/2026-06-03-agent-skills-evolution`)
- Jun 4: Memory as an Attack Surface (`.scheduled/2026-06-04-memory-attack-surface`)
- Jun 5: Autonomous Research Guardrails (`.scheduled/2026-06-05-automated-science-guardrails`)
- Jun 6: Multi-Agent Collusion (`.scheduled/2026-06-06-multi-agent-collusion`)
- Jun 7: Structured Data Prompt Injection (`.scheduled/2026-06-07-structured-data-injection`)
- Jun 8: Automated AI Red Teaming (`.scheduled/2026-06-08-automated-red-teaming`)
- Jun 9: Model Watermarking (`.scheduled/2026-06-09-model-watermarking`)
- Jun 10: Eval Benchmark Poisoning (`.scheduled/2026-06-10-eval-benchmark-poisoning`)
