...
## API-abuse / model-distillation cluster (added Sep 15, 2026)

- **CISA/NSA/FBI advisory AA26-251A** (8 Sep 2026) — "China-Based Artificial Intelligence Companies
  Conducting Industrial-Scale Distillation Campaigns Against U.S. AI Companies". Names DeepSeek,
  Moonshot AI, Alibaba, MiniMax, StepFun, Z.AI. Alleges billions of tokens across millions of
  exchanges from Claude, GPT, Gemini and Grok since at least late 2024; techniques = automated
  jailbreak tooling, rotating API keys to evade rate limits, grey-market "transfer stations" to
  bypass geo-restrictions; "likely with Chinese government awareness".
  https://www.cisa.gov/news-events/cybersecurity-advisories/aa26-251a
- **Anthropic threat-intelligence report** (11 Sep 2026) — five quantified campaigns, ~190M Claude
  exchanges; **151M attributed to Alibaba** across 3,500 fraudulent accounts between May and July
  2026, peaking near 3M/day. DeepSeek alleged to have routed its own customers' exchanges to Claude
  without notifying them (12M+ over 14 days in July). Response: account bans, **reduced reasoning-
  transcript detail**, escalation to authorities. Sources: CNBC 2026-09-11,
  https://www.businessinsider.com/china-ai-labs-millions-distillation-attacks-anthropic-claude-2026-9
- **Treasury signal** — sanctions "on the table", Entity List actions floated for firms crossing into
  IP theft; MOFCOM called the allegations an attempt to monopolise AI.
  https://www.bighatgroup.com/blog/china-ai-weekly-2026-09-13/
- **Reusable angle:** distillation abuse is a *security-control* failure (corpus-ingest request
  shapes, near-zero per-account user diversity, key-rotation velocity) that became a *compliance*
  risk (numbered advisory + Treasury signal + model provenance as a procurement question). Defence
  pattern worth citing: degrade transcript fidelity rather than only banning — lowers the value of
  future harvests without breaking legitimate calls.
- First used by: `2026-09-15-tuesday-ai-update.md` (Spotlight).
