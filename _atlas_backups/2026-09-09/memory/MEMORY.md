...
§
hodaripay (YucanPay): ~/ProG/hodaripay. Audits: docs/security-audit.md + ~/Dev/REPORTS/hodaripay/2026-08-23/. 9 repo+vendor skills in ~/.hermes/skills/hodaripay (choicebank-baas + hodaripay-*); canonical: ~/.config/opencode/skills.